...
// const CheckoutPage = ({ cartItems, onPaymentSuccess }) => {
//   const navigate = useNavigate();
//   const [currentStep, setCurrentStep] = useState(2); // 1: Shipping, 2: Billing, 3: Confirmation
...
//             </div>
//             <div className="absolute -bottom-6 left-0">Shipping</div>
//           </div>
...
//             </div>
//             <div className="absolute -bottom-6 left-1/2 -translate-x-1/2">Billing</div>
//           </div>
...
//             </div>
//             <div className="absolute -bottom-6 right-0">Confirmation</div>
//           </div>
//         </div>
//       </div>
